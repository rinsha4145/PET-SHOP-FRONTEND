...
const View = () => {
  ...
  return (
   <>
      <div className="user-details"><br/><br/><br/>
  ...
  {order.length > 0 ? (
    <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
      ...
      {order.map((order) => (
        <div key={order._id} className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full mb-8">
          <div
