    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    <li className="mb-6"><a   className="text-gray-600 hover:text-gray-900">Home</a></li>
                    <li className="mb-6"><a   className=" text-gray-600 hover:text-gray-900">About</a></li>
                    <li><a   className=" text-gray-600 hover:text-gray-900">Pricing</a></li>
                </ul>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    <li className="mb-6"><a   className="text-gray-600 hover:text-gray-900">Pets Grooming</a></li>
                    <li className="mb-6"><a   className=" text-gray-600 hover:text-gray-900">Pet insurance</a></li>
                    <li><a   className=" text-gray-600 hover:text-gray-900">Free kids workshops</a></li>
                </ul>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    <li className="mb-6"><a   className="text-gray-600 hover:text-gray-900">Customer Support</a></li>
                    <li className="mb-6"><a   className=" text-gray-600 hover:text-gray-900">Terms & Conditions</a></li>
                    <li ><a   className=" text-gray-600 hover:text-gray-900">Privacy Policy</a></li>
                </ul>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <a   className="flex items-center justify-center gap-2 border border-indigo-600 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-indigo-600 font-semibold transition-all duration-500 hover:bg-indigo-50">Subscribe<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">PAWSHOP</a> 2024, All rights reserved.</span>
